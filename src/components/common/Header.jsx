...
export function Header() {
  ...
  const leftNavX = useTransform(scrollY, [0, 300], isStaticPage ? [80, 80] : [80, -30]);

  // Right navigation movement - navegación central derecha (Locales, Nosotros, Contacto)
  const rightNavX = useTransform(scrollY, [0, 300], isStaticPage ? [-80, -80] : [-80, 30]);
  ...
  const heartIconX = useTransform(scrollY, [200, 300], isStaticPage ? [0, 0] : [0, 3]);
  const cartIconX = useTransform(scrollY, [200, 300], isStaticPage ? [0, 0] : [0, 4]);
  const userIconX = useTransform(scrollY, [200, 300], isStaticPage ? [0, 0] : [0, 5]);
          ...
          <div className="flex items-center justify-between h-16 lg:h-20 relative overflow-hidden gap-4 lg:gap-8">
            ...
            >
              <Link to="/" className="flex items-center space-x-2">
                ...
                />
                <AnimatedGradientText className="text-base sm:text-lg xl:text-xl font-bold tracking-tight hidden sm:block lg:hidden xl:block header-logo-text">
                  NONINO
                </AnimatedGradientText>
                <span className="text-base sm:text-lg xl:text-xl font-bold tracking-tight sm:hidden lg:block xl:hidden text-empanada-golden header-logo-text">
                  NONINO
                </span>
              </Link>
            </motion.div>
            ...
            <motion.nav
              style={{ x: leftNavX }}
              className="hidden lg:flex items-center space-x-2 xl:space-x-4 2xl:space-x-7 header-motion-element header-nav-spacing"
            >
            ...
            <motion.nav
              style={{ x: rightNavX }}
              className="hidden lg:flex items-center space-x-2 xl:space-x-4 2xl:space-x-7 header-motion-element header-nav-spacing lg:ml-8 xl:ml-0"
            >
