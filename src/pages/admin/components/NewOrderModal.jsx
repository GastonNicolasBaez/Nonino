                ...
                <Card className="bg-gray-50 dark:bg-gray-800">
                  ...
                  <CardContent>
                    <textarea
                      ...
                      className="w-full h-32 border-2 border-gray-300 dark:border-gray-600 bg-[#363C47] dark:bg-[#363C47] text-gray-300 dark:text-gray-300 rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-empanada-golden resize-none"
                    />
                  </CardContent>
                </Card>
              </div>
